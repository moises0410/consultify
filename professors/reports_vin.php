  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="consult_vin.php">Consultation</a></li>

        <li><a class="active"  href="reports_vin.php">Report</a></li>
    ...
    <iframe src="report/vin.php" height="700" width="1500" frameborder = "0"></iframe>
