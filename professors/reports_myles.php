  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="consult_myles.php">Consultation</a></li>

        <li><a class="active"  href="reports_myles.php">Report</a></li>
    ...
    <iframe src="report/myles.php" height="700" width="1500" frameborder = "0"></iframe>
