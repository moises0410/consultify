...
<body>
    ...
    <div class="container-report">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <input type="text" id="professor" name="professor" value="Milagros Santiago" hidden>
            </div>
            <div class="form-group">
    ...
    <div class="container-table">
        ...
        $professorFilter = "Milagros Santiago"; // Replace with the actual professor name you want to filter
