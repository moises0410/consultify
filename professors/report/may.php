...
<body>
    ...
    <div class="container-report">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <input type="text" id="professor" name="professor" value="Maylane Ballita" hidden>
            </div>
            <div class="form-group">
    ...
    <div class="container-table">
        ...
        $professorFilter = "Maylane Ballita"; // Replace with the actual professor name you want to filter
