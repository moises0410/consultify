...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `users` SET fname = '$update_fname', lname = '$update_lname', email = '$update_email' WHERE user_id = '$user_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `users` SET img = '$update_image' WHERE user_id = '$user_id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="dennis.php" class="delete-btn">go back</a>
   </form>
