  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="consult_leo.php">Consultation</a></li>

        <li><a class="active"  href="reports_leo.php">Report</a></li>
    ...
    <iframe src="report/leo.php" height="700" width="1500" frameborder = "0"></iframe>
