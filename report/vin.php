...
<body>
    ...
    <div class="container-report">
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <input type="text" id="professor" name="professor" value="Melvin Nicolas" hidden>
            </div>
            <div class="form-group">
    ...
    <div class="container-table">
        ...
        $professorFilter = "Melvin Nicolas"; // Replace with the actual professor name you want to filter
