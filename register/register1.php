...
<body>
  <div class="wrapper">
    <section class="form signup">
      <header>Professor Registration</header>
      <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="name-details">
          <div class="field input">
            ...
            <input type="text" name="stud_id" placeholder="Enter your employee number" required>
          </div>
          <div class="field input">
            <label>Department</label>
            <input type="text" name="course" placeholder="Enter your department" required>
          </div>
        </div>
        <div class="field input">
        ...
        <div class="field input">
          <input type="text" name="user_type" id="user_type" value="professor" hidden>
        </div>
