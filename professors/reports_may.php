  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a href="consult_may.php">Consultation</a></li>

        <li><a class="active"  href="reports_may.php">Report</a></li>
    ...
    <iframe src="report/may.php" height="700" width="1500" frameborder = "0"></iframe>
